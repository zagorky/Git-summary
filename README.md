...
Файл .gitignore используется для исключения определённых файлов из отслеживания Git. Для этого нужно указать имена таких файлов или папок в самом файле .gitignore.
